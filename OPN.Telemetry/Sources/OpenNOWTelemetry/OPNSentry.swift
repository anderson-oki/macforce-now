...
public enum OPNSentryDiagnosticsUploadError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .partialUpload: return "Diagnostics upload service would only save a partial log. Try again later after the rolling log advances."
        case .logTooLarge: return "Diagnostics log is too large for the upload service. Try again later after the rolling log advances."
