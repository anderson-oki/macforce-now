...
function readConfig() {
  ...
  const publicHost = stringEnv("OPENNOW_REMOTE_COOP_TURN_PUBLIC_HOST", devAllowLoopback ? "127.0.0.1" : "");
...
Required environment:
  OPENNOW_REMOTE_COOP_TURN_PUBLIC_HOST       Public DNS name or IP for clients
